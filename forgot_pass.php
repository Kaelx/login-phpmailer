...
include 'controller/credentials.php'; //create a file name credentials.php and put on your email($mailUsername = 'youremail@gmail.com') and password($mailPassword = '16 keys') for sending OTP
